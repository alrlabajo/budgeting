...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('activityjustification', function (Blueprint $table) {
            ...
            $table->decimal('cost_per_student', 12, 2);
            $table->string('method_accomplishing');
            $table->decimal('services_budget', 12, 2)->default(0);
            $table->decimal('mooe_budget', 12, 2)->default(0);
            $table->decimal('capital_outlay_budget', 12, 2)->default(0);
