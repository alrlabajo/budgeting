<div class="flex flex-row grow justify-end gap-x-2 my-px">
    ...
    <div class="justify-start items-start inline-flex">
        <a href="/amendment-form" class="w-40 h-10 px-4 bg-indigo-800 rounded-lg shadow justify-center items-center gap-2 flex">
    ...
    <script>
        function exportToCsv() {
            ...
            // Get table headers
            var headers = [];
            var headerCells = document.querySelectorAll("#amendment-table th");
            ...
            // Get table rows
            var rows = document.querySelectorAll("#amendment-table tbody tr");
