<div class="flex flex-row grow justify-end gap-x-2 my-px">
    ...
    <div class="justify-start items-start inline-flex">
        <a href="/appropriations-form" class="w-24 h-10 px-4 bg-indigo-800 rounded-lg shadow justify-center items-center gap-2 flex">
            <span class="text-white text-base whitespace-nowrap font-bold font-['Inter'] leading-tight">Add Form</span>
        </a>
    </div>
