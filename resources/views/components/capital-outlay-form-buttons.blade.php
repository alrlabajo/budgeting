<div class="flex flex-row grow justify-end gap-2">
    ...
    <select  wire:model.live="year" id="school_year" name="school_year" class="font-['Inter'] block w-60 h-10 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" style="text-indent: 10px;">
