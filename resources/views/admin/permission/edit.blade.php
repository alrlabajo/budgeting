        ...
        <div class="w-full h-full px-10 py-4 bg-white rounded-lg shadow border border-zinc-300 space-y-4">
            <form action="{{ url('permissions/'.$permission->id) }}" method="POST">
                ...
                <div class="px-6 py-2">
                    ...
                    {{-- <input type="text"  name="name" value="{{ $permission->name }}" class="w-96 h-8 px-3 py-2 rounded-md shadow border border-zinc-200 items-center gap-2 inline-flex bg-transparent text-zinc-500 text-sm font-normal font-['Inter'] leading-tight"> --}}
                </div>
                <div class="px-6 py-2">
                    <button
