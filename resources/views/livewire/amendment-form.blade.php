                            ...
                            <div class="flex flex-col m-4 gap-y-3">
                                ...
                                <div class="flex">
                                    <input type="number" name="No" 
                                        ...
                                        class="w-full h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                        placeholder="0"/>
                    ...
                    <div class="w-full sm:w-52 h-24 relative bg-white rounded-xl shadow border border-zinc-200 content-center justify-start">
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col m-4 gap-y-3">
                                ...
                                <input type="number" name="plan_no_revised" 
                                    wire:model="items.{{ $index }}.plan_no_revised"
                                    class="w-full h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                    placeholder="0"/>
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col m-4 gap-y-3">
                                ...
                                <input type="date" name="date_revision" 
                                    wire:model="items.{{ $index }}.date_revision"
                                    class="w-full h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5"/>
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col m-4 gap-y-3">
                                ...
                                <input type="number" step="0.01" name="planned_amount" 
                                    wire:model="items.{{ $index }}.planned_amount"
                                    class="w-full h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                    placeholder="₱ 0.00"/>
                    ...
                    <div class="w-full sm:w-52 h-24 relative bg-white rounded-xl shadow border border-zinc-200 content-center justify-start">
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col m-4 gap-y-3">
                                ...
                                <input type="date" name="date_submission" 
                                    wire:model="items.{{ $index }}.date_submission"
                                    class="w-full h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5"/>
                ...
                <div class="w-fit h-80 px-8 py-3 bg-white rounded-xl shadow border border-zinc-200 content-center justify-start space-y-5">
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col gap-y-3">
                                ...
                                <input type="number" name="item_No" 
                                    wire:model="items.{{ $index }}.item_No"
                                    class="w-20 h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                    placeholder="0" />
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col gap-y-3">
                                ...
                                <input type="text" name="description" 
                                    ...
                                    class="w-96 h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col gap-y-3">
                                ...
                                <input type="text" name="unit" 
                                    ...
                                    class="w-72 h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                    placeholder="Description" />
                    ...
                    <div class="flex flex-row gap-x-6">
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col gap-y-3">
                                ...
                                <input type="number" name="procurement_quantity" 
                                    wire:model="items.{{ $index }}.procurement_quantity"
                                    class="w-20 h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                    placeholder="0" />
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col gap-y-3">
                                <label class="text-zinc-950 text-sm font-medium font-['Inter'] leading-normal">Amount:</label>
                                <input type="number" step="0.01" name="procurement_amount" 
                                    wire:model="items.{{ $index }}.procurement_amount"
                                    class="w-20 h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                    placeholder="₱ 0.00" />
                        ...
                        <div class="space-y-2" action="#">
                            <div class="flex flex-col gap-y-3">
                                ...
                                <input type="text" name="procurement_justification" 
                                    wire:model="items.{{ $index }}.procurement_justification"
                                    class="w-[905px] h-8 px-2 py-1.5 bg-white rounded-md shadow border border-zinc-200 focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight gap-1.5" 
                                    placeholder="Description" />
