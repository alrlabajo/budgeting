<div class="px-6 py-32">
    ...
    <div class="w-96 h-9 justify-between items-center inline-flex py-10">
        <label class="w-96 h-8 absolute text-indigo-800 text-3xl font-extrabold font-['Inter'] leading-9 whitespace-nowrap">Personal Services Document</label>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 items-center">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <tr class="items-center">
                    ...
                    <td class="text-sm text-black border border-slate-300">
                    <input type="text" class="form-input block w-full border border-transparent text-center" placeholder="Enter text">
                    </td>
                </tr>
            </tbody>
            <tfoot>
