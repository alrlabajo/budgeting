            ...
            @csrf
                ...
                <div class="flex flex-row space-x-36">
                    ...
                    <div class="justify-start items-start space-y-3 flex flex-col">
                        ...
                        <input type="number" step="0.01" name="grade_step" 
                            wire:model="items.{{ $index }}.grade_step"
                            class="w-96 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex text-zinc-500 text-xs font-normal font-['Inter'] leading-tight" 
                            placeholder="0">
                    ...
                    <div class="justify-start items-start space-y-3 flex flex-col">
                        ...
                        <input type="text" name="position" 
                            wire:model="items.{{ $index }}.position"
                            class="w-96 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex text-zinc-500 text-xs font-normal font-['Inter'] leading-tight" 
                ...
                <div class="justify-start items-start space-y-3">
                    ...
                    <textarea name="name_incumbent" 
                        wire:model="items.{{ $index }}.name_incumbent"
                ...
                <div class="flex flex-row space-x-36">
                    ...
                    <div class="justify-start items-start space-y-3 flex flex-col">
                        ...
                        <input type="number" name="annual_salary" 
                            wire:model="items.{{ $index }}.annual_salary"
                            class="w-96 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex text-zinc-500 text-xs font-normal font-['Inter'] leading-tight" 
                            placeholder="0">
                    ...
                    <div class="justify-start items-start space-y-3 flex flex-col">
                        ...
                        <input type="number" step="0.01" name="proposed_salary" 
                            wire:model="items.{{ $index }}.proposed_salary"
                            class="w-96 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex text-zinc-500 text-xs font-normal font-['Inter'] leading-tight" 
                            placeholder="0">
                    ...
                    <div class="justify-start items-start space-y-3 flex flex-col">
                        ...
                        <input type="number" step="0.01" name="increase" 
                            wire:model="items.{{ $index }}.increase"
                            class="w-96 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex text-zinc-500 text-xs font-normal font-['Inter'] leading-tight" 
                            placeholder="0">
                ...
                <div class="flex flex-row space-x-36">
                    ...
                    <div class="justify-start items-start space-y-3 flex flex-col">
                        ...
                        <input type="number" step="0.01" name="sub_total" 
                            wire:model="items.{{ $index }}.sub_total"
                            class="w-96 h-9 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex text-zinc-500 text-xs font-normal font-['Inter'] leading-tight" 
                            placeholder="0">
