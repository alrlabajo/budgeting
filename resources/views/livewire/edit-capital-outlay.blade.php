<div class="p-2 sm:ml-64">
    ...
    <div class="flex justify-between items-center pb-4">
        ...
        <label class="w-96 h-8 absolute text-indigo-800 text-3xl font-extrabold font-['Inter'] leading-9 whitespace-nowrap">Edit budget: {{ $capital_outlay->item }}</label>
        </div>

        <div class="flex justify-end">
            <a href="{{ url('capital-outlay') }}" class="text-white font-extrabold bg-indigo-800 hover:bg-indigo-900 focus:ring-4 focus:ring-indigo-300 rounded-lg text-sm px-5 py-2.5 focus:outline-none">Back</a>
        </div>
    </div>
