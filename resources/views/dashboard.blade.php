    ...
    <div class="p-2 sm:ml-64">
        <div class="p-2 space-y-4">
            <div class="flex flex-col sm:flex-row space-x-0 sm:space-x-2 space-y-2 sm:space-y-0">
                <!-- WELCOME! -->
                <div class="relative max-w-md max-h-lg rounded-lg shadow border border-gray border-opacity-50 bg-cover bg-center w-full">
                    <div class="absolute inset-0 rounded-lg"></div>
                    <img class="max-w-md max-h-lg opacity-40 mx-auto mt-auto" src="css/images/background.png">
                ...
                <div class="flex flex-col space-y-4 w-full">
                    <!-- Budget Call Forms -->
                    <div class="max-w-xl h-56 md:h-56 sm:h-64 rounded-lg shadow border border-gray border-opacity-20 justify-center place-items-center w-full">
                        <!-- Header -->
                    ...
                    <!-- Payment Request -->
                    <div class="max-w-xl h-36 md:h-36 sm:h-72 rounded-lg shadow border border-gray border-opacity-20 justify-center place-items-center w-full">
                        <div class="flex items-center px-4 py-3">
                            <img class="w-[30px] h-[30px] mr-2" src="css/images/icon1.png">
                            <h1 class="text-xl font-extrabold text-blue-800">Payment Request Forms</h1>
                        </div>
                        <div class="grid grid-cols-2 px-2 md:gap-x-1 md:grid-cols-2 sm:grid-cols-1 justify-items-center sm:py-2 md:gap-y-2 sm:gap-y-2 sm:gap-x-4">
                ...
                <!-- Recent Activities -->
                <div class="max-w-fit max-h-md px-2 md:w-[290px] md:max-w-xl sm:max-w-2xl items-center whitespace-nowrap rounded-lg shadow border border-gray border-opacity-20 w-full">
                    ...
                    <!-- NEED FUNCTIONALITY -->
                    <div class="flex h-20 border-b-2">
                        <div class="p-1.5">
                            ...
                            <div class="flex items-top justify-between">
                                <h3 class="flex items-top text-[11px]">15 minutes ago</h3>
                                <a href="#" class="flex items-top text-[11px] text-blue-800 underline ml-[120px] btn">View form</a>
                            </div>
                        </div>
                    </div>
                    <div class="flex h-20 border-b-2">
